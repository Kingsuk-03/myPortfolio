...
const GithubPopup: React.FC<GithubPopupProps> = ({
  ...
  link = "https://github.com/Kingsuk-03/myPortfolio",
  target = "-blank",
}) => {
  return (
    <div className={`my-2 transition-all duration-500 opacity-100 translate-y-0`}>
      <a href={link} target={target} rel="noopener noreferrer">
        <button className="hover:cursor-pointer group relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px overflow-hidden">
          ...
          <span className="flex items-center justify-center gap-1 relative z-[1] dark:bg-neutral-950/90 bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full">
            <span className="relative group-hover:scale-105 transition-transform group-hover:rotate-[360deg] duration-500">
              ...
              <svg
                ...
                className="opacity-80 dark:opacity-100 star-rotate"
                style={{
                  animation:
